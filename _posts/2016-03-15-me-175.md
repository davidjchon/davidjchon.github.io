...
First image shows how a regular knee brace looks like, while the second picture shows how our device would look like with the added mechanism. <br/>

![Knee Brace with Spring]({{ site.url }}/images/ME175/Figure2.jpg) <br/>
The torsion spring would be place right next to the knee on both the left and right side.
...
Side view of spring loaded seat design.  The thick black lines represent the walker, the striped lines represent the seat cushion. <br/>
...
Read the Full Final Report: <br/>
{% highlight html %}
<a href="http://davidjchon.github.io/FinalDesignReport.pdf" class="btn btn-success">HERE</a>
{% endhighlight %}
