...
![Lock and Release System]({{ site.url }}/images/ME175/Figure6.jpg) <br/>
Lock and release system, bar attached to the spring is represented by the dotted line <br/>

![Initial 3D Model]({{ site.url }}/images/ME175/Figure7.jpg) <br/>
...
![Men Height to Age]({{ site.url }}/images/ME175/Figure8.jpg) <br/>
Height to Age Relationship for Men with Varying Confidence Levels <br/>

![Women Height to Age]({{ site.url }}/images/ME175/Figure9.jpg) <br/>
...
![Height to Weight]({{ site.url }}/images/ME175/Figure10.jpg) <br/>
...
![Human Center of Gravity]({{ site.url }}/images/ME175/Figure11.jpg) <br/>
Center of Gravity Locations and Ratios <br/>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Due to the amount of variables within the system, torque is a function of height, weight, the angle of the upper body makes with the thigh (&theta;), and the angle the calf makes with the thigh (&phi;).  The importance of a variable can be found by varying one variable and keeping the rest at a set value, this was done for the four variables.  The angle of the calf does not affect torque as much as the other variables.  The difference in maximum and minimum values are around 12 N•m when the difference for other variables are above 50 N•m.
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
![Top-Down Spring/Lock]({{ site.url }}/images/ME175/Figure12.jpg) <br/>
Top-Down View of Spring/Lock Mechanism <br/>

![Down-Top Spring/Lock]({{ site.url }}/images/ME175/Figure13.jpg) <br/>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;At this point, the physical prototype was not completed, therefore we utilized Solidworks to evaluate the prototype.  We applied numerous forces to the mechanism to see the motion of the device, where points of stress were and any issues with our design.  
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
### Appendices
{::nomarkdown}
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=XihWt045EAs" frameborder="0" allowfullscreen></iframe>
{:/nomarkdown}

![TvH Constant]({{ site.url }}/images/ME175/Figure14.jpg) <br/>
Torque vs Height with Constant Variables (&theta;=60°, &phi;=75°, Weight=145 lbs) <br/>

![TvW Constant]({{ site.url }}/images/ME175/Figure15.jpg) <br/>
Torque vs Weight with Constant Variables (&theta;=60°, &phi;=75°, Height=67.75 in) <br/>

![TvP Constant]({{ site.url }}/images/ME175/Figure16.jpg) <br/>
Torque vs Phi with Constant Variables (&theta;=60°,Weight=145 lb, Height=67.75 in) <br/>

![TvTheta Constant]({{ site.url }}/images/ME175/Figure17.jpg) <br/>
Torque vs Theta with Constant Variables (&phi;=75°, Weight=145 lbs, Height=67.75 in) <br/>

![Final Prototype w/o Padding]({{ site.url }}/images/ME175/Figure18.jpg) <br/>
Prototype without padding or attachment sleeve <br/>

![Transparent Prototype]({{ site.url }}/images/ME175/Figure19.jpg) <br/>
Transparent version of the prototype to show how all of the pieces connect <br/>

![Exploded View Prototype]({{ site.url }}/images/ME175/Figure20.jpg) <br/>
Exploded view of the prototype <br/>

![Stress Analysis Prototype]({{ site.url }}/images/ME175/Figure21.jpg) <br/>
Stress Analysis of the prototype generated on Solidworks.  As expected the springs experience the majority of the stress <br/>

![Force Analysis Prototype]({{ site.url }}/images/ME175/Figure22.jpg) <br/>
Force analysis of the prototype generated on Solidworks.  The bottom part of the knee braces rotates and displaces the most as weight is added <br/>
