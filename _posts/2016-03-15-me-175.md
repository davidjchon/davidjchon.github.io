...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;In order to decide which design was best we decided to opt for the weighted decision matrix. To help decide which design to use, the designs were compared based on the characteristics and rated them 1 through 3.  The design with the highest score is the one we would proceed with. <br/>
