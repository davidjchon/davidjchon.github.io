...
Given conditions: <br/>
COnsider the unit square [0,1]<sup>2</sup> in the plane. Pick an arbitrary integer k and do:
...
%Chagne Parameters [0 1]62 or [0 2*pi]^2
xx = 0:2 • pi/k:2 • pi;
yy = 0:2 • pi/k:2 • pi;
...
![GridHalton for 100,2,3]({{ site.url }}/imges/ME145/GridHalton100.jpg)
